...
// Native classes
// Method closures
$$.BoundClosure$1 = [S, {"": "BoundClosure;_self,_target,_receiver,__js_helper$_name",
  call$1: function(p0) {
...
["DROID_AGE_CLIENT", "droidageclient.dart", , S, {
main: function() {
  var t1, game, t2;
...
Display_init: function() {
  ...
  J.set$width$x($.Display_canvas, 640);
  J.set$height$x($.Display_canvas, 480);
  $.Display_renderer = J.getContext$1$x($.Display_canvas, "2d");
},

Display_renderRect: function(x, y, w, h, color, fill) {
  var t1;
  x = J.$sub$n(x, $.Display_xOffset);
  y = J.$sub$n(y, $.Display_yOffset);
  t1 = $.Display_renderer;
  if (fill) {
    J.set$fillStyle$x(t1, color);
    J.fillRect$4$x($.Display_renderer, x, y, w, h);
  } else {
    J.set$strokeStyle$x(t1, color);
    J.strokeRect$4$x($.Display_renderer, x, y, w, h);
  }
},
...
Game_render_closure: {"": "Closure;",
  call$1: function(p) {
    var t1 = J.getInterceptor$x(p);
    S.Display_renderRect(t1.get$x(p), t1.get$y(p), 20, 20, "red", true);
  },
  $is_args1: true
},
...
DroidAgeClient: {"": "Object;socket,parser,game",
  setup$0: function() {
    var t1, t2;
    t1 = new W._EventStream(this.socket, C.EventStreamProvider_message._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new S.DroidAgeClient_setup_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  send$1: function(_, str) {
    this.socket.send(str);
  },
  getParser$0: function() {
    return P.Future_Future(new S.DroidAgeClient_getParser_closure(this), S.DataParser);
  },
  DroidAgeClient$1: function(game) {
    this.parser = new S.DataParser();
    this.socket = W.WebSocket_WebSocket("ws://208.107.120.173:11011", null);
    this.setup$0();
  },
  static: {
"": "DroidAgeClient_HOST_IP",
DroidAgeClient$: function(game) {
  var t1 = new S.DroidAgeClient(null, null, game);
  t1.DroidAgeClient$1(game);
  return t1;
}}

},

DroidAgeClient_setup_closure: {"": "Closure;this_0",
  call$1: function($event) {
    var t1 = this.this_0;
    t1.getParser$0().then$1(new S.DroidAgeClient_setup__closure(t1, $event));
  },
  $is_args1: true
},

DroidAgeClient_setup__closure: {"": "Closure;this_1,event_2",
  call$1: function(parser) {
    parser.parse$2(J.get$data$x(this.event_2), this.this_1);
  },
  $is_args1: true
},

DroidAgeClient_getParser_closure: {"": "Closure;this_0",
  call$0: function() {
    return this.this_0.parser;
  }
},

DataParser: {"": "Object;",
  parse$2: function(str, client) {
    var data, posx, posy;
    data = J.split$1$s(str, "~");
    if (0 >= data.length)
      throw H.ioore(data, 0);
    if (J.$eq(data[0], "0")) {
      P.print("Adding point");
      if (1 >= data.length)
        throw H.ioore(data, 1);
      posx = H.Primitives_parseInt(data[1], null, null);
      if (2 >= data.length)
        throw H.ioore(data, 2);
      posy = H.Primitives_parseInt(data[2], null, null);
      client.game.addPoint$2(posx, posy);
    }
  }
}},
1],
...
Interceptor: {"": "Object;",
  ...
  "%": "ArrayBuffer|Blob|CanvasGradient|CanvasPattern|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGPointList"
},
...
_MessageTraverser: {"": "Object;",
  ...
  get$_dispatch: function() {
    return new S.BoundClosure$1(this, H._MessageTraverser.prototype._dispatch$1, null, "_dispatch$1");
  },
...
function dart_precompiled($collectedClasses) {
  ...
  function Game(client, timer, running, points) {
    this.client = client;
    this.timer = timer;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  function Game_render_closure() {
  }
  Game_render_closure.builtin$cls = "Game_render_closure";
  if (!"name" in Game_render_closure)
    Game_render_closure.name = "Game_render_closure";
  $desc = $collectedClasses.Game_render_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_render_closure.prototype = $desc;
  ...
  DroidAgeClient.builtin$cls = "DroidAgeClient";
  if (!"name" in DroidAgeClient)
    DroidAgeClient.name = "DroidAgeClient";
  $desc = $collectedClasses.DroidAgeClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DroidAgeClient.prototype = $desc;
  function DroidAgeClient_setup_closure(this_0) {
    this.this_0 = this_0;
  }
  DroidAgeClient_setup_closure.builtin$cls = "DroidAgeClient_setup_closure";
  if (!"name" in DroidAgeClient_setup_closure)
    DroidAgeClient_setup_closure.name = "DroidAgeClient_setup_closure";
  $desc = $collectedClasses.DroidAgeClient_setup_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DroidAgeClient_setup_closure.prototype = $desc;
  function DroidAgeClient_setup__closure(this_1, event_2) {
    this.this_1 = this_1;
    this.event_2 = event_2;
  }
  DroidAgeClient_setup__closure.builtin$cls = "DroidAgeClient_setup__closure";
  if (!"name" in DroidAgeClient_setup__closure)
    DroidAgeClient_setup__closure.name = "DroidAgeClient_setup__closure";
  $desc = $collectedClasses.DroidAgeClient_setup__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DroidAgeClient_setup__closure.prototype = $desc;
  function DroidAgeClient_getParser_closure(this_0) {
    this.this_0 = this_0;
  }
  DroidAgeClient_getParser_closure.builtin$cls = "DroidAgeClient_getParser_closure";
  if (!"name" in DroidAgeClient_getParser_closure)
    DroidAgeClient_getParser_closure.name = "DroidAgeClient_getParser_closure";
  $desc = $collectedClasses.DroidAgeClient_getParser_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DroidAgeClient_getParser_closure.prototype = $desc;
  function DataParser() {
  }
  DataParser.builtin$cls = "DataParser";
  if (!"name" in DataParser)
    DataParser.name = "DataParser";
  $desc = $collectedClasses.DataParser;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DataParser.prototype = $desc;
